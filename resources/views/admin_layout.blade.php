...
<body>
    <section id="container">
        ...
        <header class="header fixed-top clearfix">
            <!--logo start-->
            <div class="brand">
                <a href="{{url('http://localhost:8080/Project4/thongke')}}" class="logo">
                    ADMIN
                </a>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{asset('public/frontend/image/VansXanhLa.jpg')}}">
                            <span class="username">
                                <?php
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-khachhang')}}">Thêm khách hàng</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-nhacungcap')}}">Thêm nhà cung cấp</a></li>
                                <li><a href="{{URL::to('/all-nhacungcap')}}">Liệt kê nhà cung cấp</a></li>
                            </ul>
                        </li>


                        <li class="sub-menu">
                            <a href="{{URL::to('/all_bill')}}">
                                <i class="fa fa-book"></i>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{route('tintuc.index')}}">Tin tức</a></li>
                                <li><a href="{{route('tintuc.create')}}">Thêm mới</a></li>
                            </ul>
                        </li>
                    </ul>            
                </div>
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                  <p>nguyennga050620@gmail.com | Nga Nguyễn <a href="http://w3layouts.com">Dong He Sport</a></p>
              </div>
          </div>
          <!-- / footer -->
      </section>
...
<!-- <script type="text/javascript">
    $(window).load( function() {
        ...
        data: [
           {label:"Sản phẩm", value:81},
           {label:"nhân viên", value:3},
           {label:"loại", value:11},
           {label:"Đơn hàng", value:3},
           {label:"Tin tức", value:5}
        ]
        });
});
</script> -->
...
<!-- <script type="text/javascript">
    $(window).load( function() {
        $( "#btn-dashboard-filter" ).click(function() {
            ...
            var from_date=$('datepicker').val();//lấy từ ngày mấy lấy từ id datepicker
            var to_date=$('datepicker2').val();//đến ngày mấy
             $$.ajax({
                 url: "{{url('/filter-by-date')}}",//filter lọc bởi ngày
                 method:"POST",
                 dataType:"JSON",
                 data: {from_date:from_date,to_date:to_date,token:token},
...
<script type="text/javascript">
    CKEDITOR.replace("ckeditor_noidungtin");
    CKEDITOR.replace("ckeditor_trichdan");
    CKEDITOR.replace("ckeditor_tieude");
    CKEDITOR.replace("ckeditorpro1");
